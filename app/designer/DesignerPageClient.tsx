  ...
  const galleryProjects = [
    {
      ...
      url: "https://www.behance.net/dhiaarfa",
    },
    {
  ...
  return (
    <div className="w-full min-h-screen bg-background">
      ...
      <main className="w-full pt-20">
        {/* Hero Section */}
        <section className="relative w-full min-h-screen flex items-center pt-16 md:pt-0 overflow-hidden bg-gradient-to-b from-background to-background/50">
          <div className="w-full px-4 md:px-8">
            <div className="max-w-7xl mx-auto space-y-8">
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
                <div className="flex items-center gap-3 mb-[0]">
                  <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/222-u48A4T9GJlR5FkrkiUgVmcx3GY05RE.png" alt="Zia Studio" className="h-48 object-contain" />
                </div>
          ...
          <motion.div
            className="hidden md:flex h-full min-h-[600px] items-center justify-end pr-8"
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.8, delay: 0.2 }}
          >
            <img className="px-0 py-0 my-0"
              ...
              style={{width: "100%", maxWidth: "550px", height: "auto", objectFit: "contain", borderRadius: "24px", display: "block"}}
            />
          </motion.div>
        </section>

        {/* Sticky Notes - Top Right Corner */}
        <div className="absolute top-4 right-4 space-y-0 my-[85px]">
        ...
        <section className="w-full py-20 md:py-32 px-4 md:px-8 bg-gradient-to-b from-background via-[hsl(var(--zia-green))]/3 to-background">
        ...
        {/* Portfolio Gallery */}
        <section id="gallery" className="w-full py-20 md:py-32 px-4 md:px-8">
          <div className="max-w-7xl mx-auto">
            <motion.div
              className="space-y-16"
              initial={{ opacity: 0 }}
            ...
            >
              ...
              {/* Masonry-style grid portfolio inspired by Liandong Zhou */}
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-max">
                {galleryProjects.map((project, index) => (
                  <motion.a
                    ...
                    whileHover={{ y: -8 }}
                  >
                    <div className="aspect-video md:aspect-square w-full overflow-hidden bg-foreground/10">
                      <img
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <motion.a
                ...
                rel="noopener noreferrer"
                whileHover={{ y: -4 }}
                className="p-6 rounded-2xl border border-border hover:border-[hsl(var(--zia-green))]/30 transition-all cursor-pointer group"
              >
                View Full Portfolio
                <ArrowLeft className="h-4 w-4 rotate-180" />
              </motion.a>
