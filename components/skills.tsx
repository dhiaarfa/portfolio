      ...
      <div className="container px-4 md:px-6 relative z-10">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            <motion.div
              className="inline-block rounded-full bg-[hsl(var(--zia-green))]/10 px-3 py-1 text-sm font-medium text-[hsl(var(--zia-green))] dark:bg-[hsl(var(--zia-green))]/20 dark:text-[hsl(var(--zia-green))]/80 font-montserrat"
            ...
            <motion.h2
              className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl bg-gradient-to-r from-[hsl(var(--zia-green))] to-purple-600 bg-clip-text text-transparent"
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-2">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="mb-8 text-2xl font-bold text-center flex items-center justify-center gap-2 bg-gradient-to-r from-[hsl(var(--zia-green))] to-purple-600 bg-clip-text text-transparent">
              <PenTool className="h-6 w-6 text-[hsl(var(--zia-green))]" />
            ...
            <div className="grid grid-cols-2 gap-6 sm:grid-cols-4">
              {tools.map((tool, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <div style={{width: "64px", height: "64px", borderRadius: "50%", backgroundColor: "white", boxShadow: "0 10px 25px rgba(0,0,0,0.1)", display: "flex", alignItems: "center", justifyContent: "center", padding: "8px"}}>
                    <img src={tool.image || "/placeholder.svg"} alt={tool.name} style={{width: "40px", height: "40px", objectFit: "contain"}} />
                  </div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="mb-8 text-2xl font-bold text-center flex items-center justify-center gap-2 bg-gradient-to-r from-green-600 to-[hsl(var(--zia-green))] bg-clip-text text-transparent">
