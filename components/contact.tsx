...
export default function Contact({ language }: ContactProps) {
  ...
  const contactInfo = [
    {
      icon: <Mail className="h-5 w-5 text-[hsl(var(--zia-green))] dark:text-[hsl(var(--zia-green))]/80" />,
      title: t("email"),
      ...
      <div className="container px-4 md:px-6 relative z-10">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            <motion.div
              className="inline-block rounded-full bg-[hsl(var(--zia-green))]/10 px-3 py-1 text-sm font-medium text-[hsl(var(--zia-green))] dark:bg-[hsl(var(--zia-green))]/20 dark:text-[hsl(var(--zia-green))]/80"
              initial={{ opacity: 0, scale: 0.8 }}
        ...
        <div className="mt-16 grid gap-8 lg:grid-cols-2">
          ...
          >
            <div className="space-y-6">
                  ...
                  >
                    ...
                    >
                      <CardContent className="p-4 flex items-center gap-4">
                        ...
                        <div>
                          <h4 className="font-medium group-hover:text-[hsl(var(--zia-green))] transition-colors">{info.title}</h4>
              ...
              <motion.div
                className="mt-8 p-6 bg-[hsl(var(--zia-green))]/5 dark:bg-[hsl(var(--zia-green))]/10 rounded-lg glass"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
                  <motion.li
                    ...
                    viewport={{ once: true }}
                  >
                    <div className="mr-2 h-2 w-2 rounded-full bg-[hsl(var(--zia-green))] animate-pulse"></div>
              ...
              <CardContent className="p-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                    <Button
                      type="submit"
                      className="w-full bg-gradient-to-r from-[hsl(var(--zia-green))] to-purple-600 hover:from-[hsl(var(--zia-green))]/90 hover:to-purple-700 transition-all duration-300"
