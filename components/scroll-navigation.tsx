      ...
      {isVisible && (
        <div className="fixed bottom-36 right-4 md:right-8 flex flex-col gap-3 z-40">
          ...
          <motion.button
            ...
            onClick={scrollToTop}
            className="w-12 h-12 rounded-full bg-white dark:bg-muted text-foreground border border-border shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-200 flex items-center justify-center"
