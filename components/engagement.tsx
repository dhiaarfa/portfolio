              ...
              <Card className="h-full">
                <CardContent className="p-6">
                  <div className="flex items-center gap-4 mb-4">
                    <div className="h-16 w-16 overflow-hidden rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center flex-shrink-0">
                    ...
                    <ul className="space-y-2 text-gray-500 dark:text-gray-400">
                      {engagement.roles.slice(0, 4).map((role, idx) => (
                        <li key={idx} className="flex items-start">
                          <div className="mr-2 mt-1.5 h-1.5 w-1.5 rounded-full bg-[hsl(var(--zia-green))]"></div>
                          <span className="text-sm">{role}</span>
                        </li>
                      ))}
                      {engagement.roles.length > 4 && (
                        <li className="text-sm text-[hsl(var(--zia-green))] dark:text-[hsl(var(--zia-green))]/80 font-medium">
