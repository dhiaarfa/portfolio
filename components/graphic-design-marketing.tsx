      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="mt-16 flex flex-wrap justify-center gap-2">
          ...
          <Button
            ...
            className={activeFilter === "marketing" ? "bg-gradient-to-r from-blue-500 to-cyan-600" : ""}
          >
            Marketing
          </Button>
          <Button
          ...
          {filteredItems.map((item, index) => (
            ...
            >
              <Card className="overflow-hidden border-0 shadow-lg hover:shadow-xl transition-shadow group cursor-pointer">
                <div className="aspect-video relative overflow-hidden bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
                  <img
