...
import { GraduationCap, Briefcase as Certificate } from "lucide-react"
  ...
  const education = [
    {
      ...
      gradient: "from-[hsl(var(--zia-green))] to-purple-500",
    },
    {
        ...
        <div className="mt-16 grid gap-10 md:grid-cols-2">
          ...
          >
            <h3 className="text-2xl font-bold flex items-center gap-2">
              <GraduationCap className="h-6 w-6 text-[hsl(var(--zia-green))]" />
              Academic Background
            </h3>
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      {item.logo && (
                        <div className="mt-3">
                          <img src={item.logo || "/placeholder.svg"} alt="Institution Logo" className="h-12 w-auto opacity-80" />
                        </div>
                      )}
                    </div>
                  </div>
          ...
          >
            <h3 className="text-2xl font-bold flex items-center gap-2">
              <Certificate className="h-6 w-6 text-[hsl(var(--zia-green))]" />
