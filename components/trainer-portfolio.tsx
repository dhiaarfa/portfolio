    ...
    <section id="training-capacity-building" className="py-20 bg-gray-50 dark:bg-gray-900">
      <div className="container px-4 md:px-6">
              ...
              >
                <Card className="h-full">
                  <CardContent className="p-6">
                    ...
                    <p className="text-blue-600 dark:text-blue-400 font-medium mb-1">{center.role}</p>
            ...
            {recognitions.map((recognition, index) => (
              ...
              >
                <Card className="h-full text-center">
                  <CardContent className="p-6">
                    <div className="h-16 w-16 mx-auto mb-4 overflow-hidden rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center">
                      <img
                        src={recognition.logo || "/placeholder.svg"}
                        alt={recognition.organization}
                        className="w-12 h-12 object-contain"
                      />
                    </div>
                    <h4 className="text-lg font-bold mb-2">{recognition.organization}</h4>
                    <div className="inline-block bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 px-3 py-1 rounded-full text-sm font-medium mb-3">
        ...
        <div className="mt-16 text-center">
          <Button
            size="lg"
            className="bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 transition-all gap-2"
