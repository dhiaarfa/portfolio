  ...
  const internationalDelegations = [
    {
      ...
      icon: <Globe className="h-6 w-6 text-[hsl(var(--zia-green))]" />,
      color: "border-l-[hsl(var(--zia-green))]",
      bgColor: "bg-[hsl(var(--zia-green))]/10 dark:bg-[hsl(var(--zia-green))]/20",
    },
    {
  ...
  return (
    <section id="civic-work" className="py-20 bg-white dark:bg-gray-950 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden opacity-5">
        <div className="absolute top-20 left-10 w-72 h-72 bg-gradient-to-r from-[hsl(var(--zia-green))] to-purple-500 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-r from-green-400 to-[hsl(var(--zia-green))] rounded-full blur-3xl animate-pulse delay-1000"></div>
      </div>
      ...
      <div className="container px-4 md:px-6 relative z-10">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <motion.h2
              className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl bg-gradient-to-r from-green-600 to-[hsl(var(--zia-green))] bg-clip-text text-transparent"
        ...
        <div className="mt-16">
          <motion.h3
            ...
            viewport={{ once: true }}
          >
            <Globe className="h-6 w-6 text-[hsl(var(--zia-green))]" />
              ...
              >
                ...
                >
                  ...
                  <CardContent className="p-6">
                      ...
                      <div className="flex flex-col items-center gap-2">
                        ...
                        {delegation.logo && (
                          <div className="w-12 h-12 rounded-full overflow-hidden bg-white shadow-md">
                            <img src={delegation.logo || "/placeholder.svg"} alt={delegation.title} className="w-full h-full object-contain p-1" />
                          </div>
                        )}
                      </div>
                      <div className="flex-1">
                        <h4 className="text-xl font-bold mb-1 group-hover:text-[hsl(var(--zia-green))] transition-colors">
                          {delegation.title}
                        </h4>
                        ...
                        <div className="inline-block bg-gradient-to-r from-[hsl(var(--zia-green))]/10 to-purple-100 dark:from-[hsl(var(--zia-green))]/20 dark:to-purple-900/30 text-[hsl(var(--zia-green))] dark:text-[hsl(var(--zia-green))]/80 px-3 py-1 rounded-full text-sm font-medium mb-3">
                    ...
                    <div className="p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg border-l-4 border-l-[hsl(var(--zia-green))]/30">
                ...
                <Card className="h-full hover:shadow-xl transition-all duration-300 group glass">
                  <CardContent className="p-6">
                    <div className="flex items-center gap-4 mb-4">
                      <motion.div
                        className="h-16 w-16 overflow-hidden rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center group-hover:scale-110 transition-transform duration-300 flex-shrink-0"
                        whileHover={{ rotate: 5 }}
                      >
                        <img src={engagement.logo || "/placeholder.svg"} alt={engagement.organization} className="w-12 h-12 object-contain" />
                      </motion.div>
                      <div>
