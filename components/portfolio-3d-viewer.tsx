        ...
        <div className="absolute top-4 left-4 z-10 pointer-events-auto">
          <Card className="w-64">
            <CardContent className="p-4">
              ...
              <div className="text-[hsl(var(--zia-green))] font-bold">Cliquez pour explorer</div>
            </CardContent>
          </Card>
        </div>
      )}
  ...
  return (
    <div className="flex items-center justify-center h-full bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800/30 dark:to-gray-700/30 rounded-lg">
      <div className="text-center">
        ...
        <p className="text-[hsl(var(--zia-green))] dark:text-[hsl(var(--zia-green))]/80 font-medium">Chargement...</p>
      </div>
    </div>
  )
}
  ...
  return (
    <div className="flex items-center justify-center h-full bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800/30 dark:to-gray-700/30 rounded-lg">
      <div className="text-center p-6">
        <div className="w-20 h-20 bg-gradient-to-br from-[hsl(var(--zia-green))] to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
