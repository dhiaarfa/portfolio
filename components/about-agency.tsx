...
export default function AboutAgency() {
  const values = [
    {
      icon: <Target className="h-8 w-8 text-[hsl(var(--zia-green))]" />,
      title: "Excellence",
      description:
        ...
        <div className="grid gap-12 lg:grid-cols-2 items-center">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center p-4 bg-[hsl(var(--zia-green))]/10 dark:bg-[hsl(var(--zia-green))]/20 rounded-lg">
                <div className="text-2xl font-bold text-[hsl(var(--zia-green))]">2025</div>
            ...
            <Button
              size="lg"
              className="bg-gradient-to-r from-[hsl(var(--zia-green))] to-purple-600 hover:from-[hsl(var(--zia-green))]/90 hover:to-purple-700"
              onClick={() => {
            ...
            <div className="grid gap-4">
              {values.map((value, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <Card className="border-l-4 border-l-[hsl(var(--zia-green))] hover:shadow-lg transition-shadow">
