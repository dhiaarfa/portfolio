  ...
  return (
    <div className="flex items-center justify-center h-full">
      <div className="text-center">
        <div className="w-32 h-20 bg-gradient-to-br from-blue-600 to-blue-800 rounded-lg flex items-center justify-center mx-auto mb-4 shadow-2xl animate-pulse">
          <span className="text-white font-bold text-2xl">MD</span>
        </div>
        <p className="text-blue-600 dark:text-blue-400 font-medium">Chargement du logo 3D...</p>
      </div>
    </div>
  )
}
...
function StaticLogo() {
  return (
    <div className="flex items-center justify-center h-full">
      <div className="text-center">
        <div className="w-32 h-20 bg-gradient-to-br from-blue-600 to-blue-800 rounded-lg flex items-center justify-center mx-auto mb-4 shadow-2xl animate-float">
          <span className="text-white font-bold text-2xl">MD</span>
        </div>
        <h3 className="text-xl font-bold text-blue-800 dark:text-blue-400">Mohamed Dhia</h3>
        <p className="text-blue-600 dark:text-blue-300 text-sm">Designer & Formateur</p>
      </div>
    </div>
  )
}
