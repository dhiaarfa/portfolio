  ...
  return (
    <div className="flex items-center justify-center h-full bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800/30 dark:to-gray-700/30 rounded-lg">
      <div className="text-center">
        ...
        <p className="text-blue-600 dark:text-blue-400 font-medium">Chargement du modèle 3D...</p>
      </div>
    </div>
  )
}
            ...
            <Tabs defaultValue="0" onValueChange={(value) => setActiveModel(Number.parseInt(value))}>
              ...
              {models.map((model, index) => (
                <TabsContent key={index} value={index.toString()} className="space-y-4">
                  <div className="aspect-video overflow-hidden rounded-lg bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900/30 dark:to-purple-900/30 flex items-center justify-center">
                    <div className="text-center">
