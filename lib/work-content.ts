...
Video wasn't part of the original brief, and Instagram has shifted toward it since. If I revisited this today, I'd build a short set of Reel/Story motion templates alongside the static system from day one instead of retrofitting them later.
...
With a tight timeline and a growing speaker lineup, I built one flexible template family rather than bespoke layouts per speaker or session. That kept the team able to publish daily without waiting on me, but it meant some visual repetition across the countdown series that a fully custom approach would have avoided.

## What I'd do differently

With more lead time, I'd design two or three template variants instead of one, so the feed reads as consistent without individual posts starting to look interchangeable by the third week of the countdown.
...
**Live:** [digimytch-talent-hub.vercel.app](https://digimytch-talent-hub.vercel.app/) · **Code:** [GitHub](https://github.com/dhiaarfa)`,
  ...
  "crit-tunisie": `CRIT Tunisie is a **corporate recruitment platform** I helped build during my web developer role (Sep–Dec 2025). The site had to clarify services for both job seekers and client companies without feeling like a generic template.
