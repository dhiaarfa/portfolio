/** Full article bodies (English). Metadata lives in lib/insights.ts */
...
> **Want the templates?** Grab my free [Social Media Kit](/freebies?category=design) resources, or [book a free call](https://calendly.com/benarfa367/30min) if you want help building a system for your brand.`,
  ...
  "training-needs-assessment-basics": `The most expensive mistake in training isn't bad delivery. It's **training the wrong thing**. I've walked into rooms where the slides were polished, the facilitator was skilled, and the participants still left thinking "this wasn't for us." That's almost always a needs assessment failure, not a facilitation failure.
